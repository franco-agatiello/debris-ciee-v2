...
   menuClase.innerHTML = `<li><a class="dropdown-item" href="#" data-value="">Todas</a></li>` +
...
     if (filtros.masaMin && Number(d.masa_orbital) < Number(filtros.masaMin)) return false;
     if (filtros.masaMax && Number(d.masa_orbital) > Number(filtros.masaMax)) return false;
...
   if(d.masa_orbital !== null && d.masa_orbital !== undefined) contenido += `Masa orbital: ${d.masa_orbital} kg<br>`;
