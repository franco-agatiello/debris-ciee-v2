import * as THREE from 'three'; 
  ...
  function filtrarDatos() { 
    ...
    return debris.filter(d=>{ 
      ...
      if (filtros.clase && d.clase_objeto !== filtros.clase) return false;
      if (filtros.masaMin && (d.masa_kg === null || Number(d.masa_kg) < Number(filtros.masaMin))) return false;
      if (filtros.masaMax && (d.masa_kg === null || Number(d.masa_kg) > Number(filtros.masaMax))) return false;
  ...
  function popupContenidoDebris(d,index){ 
    ...
    if(d.masa_kg !== null && d.masa_kg !== undefined) contenido += `Masa: ${d.masa_kg} kg<br>`;
