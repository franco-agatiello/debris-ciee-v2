...
function filtrarDatos() { 
  ...
  return debris.filter(d=>{ 
    ...
    if (filtros.masaMin && Number(d.tamano_caida_kg) < Number(filtros.masaMin)) return false;
    if (filtros.masaMax && Number(d.tamano_caida_kg) > Number(filtros.masaMax)) return false;
